    ...
    class Scenario
    {
        ...
        public static void Chapter3a(Data data, Character user)
        {
            ...
            else if (data.Gamedata[15] == Program.Decisions["3Ab"])
            {
                ...
                Program.Print("important job to do *POOOFS*", 'm');
            }
            else
            {
        ...
        public static void Chapter3b(Data data, Character user)
        {
            ...
            {
                Program.Print("Unfortunately, the king knew better about wine than you and saw your plan through you. \nThe King is still alive, however, you managed to escape", 'w');
            }
            ...
            {
                Program.Print("You decided not to kill the king. \nThe queen send you a letter to go back to her Kingdom", 'w');
            }
        ...
        public static void Chapter4(Data data, Character user)
        {
            ...
            if (isQueenAlive == true)
            {
                if (data.Gamedata[13] != Program.Decisions["1b"])
                {
                    ...
                    if (data.Gamedata[18] == Program.Decisions["4d"])
                    {
                        ...
                        {
                            Program.Print("Ziva: What? A dragon? Haha.. I do not believe you. You know what? \nYou are lucky that I did not sentence you to death in the cell...", 'y');
                            data.Gamedata[20] = Program.Decisions["6b"];
                        }
                    }
                ...
                {
                    Program.Print(user.name + ": Your highness, the Kingdom is ging to be attacked by Zoorg's secret weapon. \nI need dragon's shell to protect your Kingdom!", 'b');
                    Program.Print("The prediction, came true. Our Kingdom has a real fighter! Take my ring! \nIt is made of dragon's shell. Find the dragon, and kill", 'y');
                    Program.Print("*Go to teleporter whenever you will be ready*", 'w');
                    data.Gamedata[20] = Program.Decisions["6a"];
                }
            ...
            {
                data.Gamedata[20] = Program.Decisions["6b"];
                Program.Print("*When you came to the Kingdom, whole city has been already on fire. \nYou have found the Queen's ring decorated with dragon's shell. Now you can fight against dragon. You have failed, but your dreams may still come true!*", 'w');
        ...
        public static void QueenSafeEnding(Data data, Character user, Item mythings)
        {
            if (data != null && data.Gamedata[20] == Program.Decisions["6a"])
            {
                ...
                Console.WriteLine("-Yes, I thought he'll kill us all. Thank you for saving my kingdom. \nTake this medallion as my token of gratitude");
                System.Threading.Thread.Sleep(4000);
                Console.ForegroundColor = ConsoleColor.White;
        ...
        public static void GirlWithMatches(Character user, Item mythings, Data data)
        {
            ...
            Program.Print("Girl: Hello, wanna buy some matches? My father won't let me warm until I sell everything. \n[Your account ballance: " + user.Money_player + "Dragon Coins]", 'm');
            Console.ForegroundColor = ConsoleColor.White;
        ...
        public static void Mergoth(Character user, Item mythings, Data data)
        {
            ...
            switch (choice)
            {
                ...
                case '3':
                    ...
                    Program.Print("Mergoth: Please, I pinky-promise! <3", 'm');
        ...
        {
            Title();
            Program.Print("-Hey, do you remember me? It's me,Ambe! You saved my life, I'll never forget this. \nTake my money as a small token of our gratitude", 'm');
        ...
        public static int BartenderQuotes(Data data)
        {
            ...
            {
                Program.Print("Innkeeper: I heard that you made our princess upset. \nI have an advice for you for your safety do what she wants.", 'y');
            }
        ...
        public static int ShopkeeperQuotes(Data data)
        {
            ...
            {
                Program.Print("Shopkeeper: I don't like people like you. \nStay away from our Kingdom!", 'y');
                additionalprize = 110;
            }
            else if (data.gamedata[20] == Program.Decisions["6a"] && data.gamedata[13] != Program.Decisions["1b"])
            {
                Program.Print("Shopkeeper: You are a hero! You saved our queen! \nI've just realized how much I was wrong", 'y');
            }
            else
            {
        ...
        public static void Prologue(Data data)
        {
            ...
            do
            {
                Program.Print("Nice to meet you " + name + "! I'm Neth and let me introduce the" +
                    " kingdom of Omaghan. \nDuring your journey you can serve our queen as a sorcerer or as a warrior. \nBy the way, could you tell me what's your actual speciality?", 'm');
